...
public class LimelightSubsystem extends SubsystemBase {
    ...
    public double getPlaneDistance() {
        ...
        return (Limelight.TARGET_ELEVATION - Limelight.CAMERA_ELEVATION)
                / Math.tan(Math.toRadians(Limelight.CAMERA_ANGLE + getPitch()));
    }
    ...
    public double getDistance() {
        ...
        return (Limelight.TARGET_ELEVATION - Limelight.CAMERA_ELEVATION)
                / Math.sin(Math.toRadians(Limelight.CAMERA_ANGLE + getPitch()));
    }
